#include "src/mesin_kar_mesin_kata/mesin_kata.h"
#include "src/listskill/listskill.h"
#include "src/boolean.h"
#include "src/player/player.h"
#include "src/status/status.h"
#include <stdio.h>
#include <stdlib.h>
#include "src/map_portal/map.h"
#include <time.h>
#include <math.h>
#include "src/status/undo.h"

int main() {
    /*Baca map*/
    int o, k;
    char arr [100];
    char input[100] = "src/map_portal/map.txt";
    MAP M;
    Portal Pt;
    status S;
    Stack st;
